...
#line 12 "..\\main.c"
#line 1 "..\\..\\..\\..\\LibM051Series\\M051-LB_004_Driver\\inc\\EEPROM_24LC64.h"
...
void _I2C_WAIT_READY_TIMEOUT(I2C_T *port) {
	extern uint32_t CyclesPerUs;
	((SysTick_Type *) ((0xE000E000) + 0x0010))->LOAD = 2000 * CyclesPerUs;
	((SysTick_Type *) ((0xE000E000) + 0x0010))->VAL  =  (0x00);
	((SysTick_Type *) ((0xE000E000) + 0x0010))->CTRL = (1ul << 2) | (1ul << 0);

	while(((port)->I2CON & (1ul << 3)) == 0
		&& (((SysTick_Type *) ((0xE000E000) + 0x0010))->CTRL & (1ul << 16)) == 0);
...
void I2C_Init(void)
{
  ...
  ((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CLK = ((120)-1);  
	((((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)))->I2CTOC |= (1ul << 2));
}
...
uint8_t EEPROM_Read(uint32_t u32Addr)
{
    ...
    do 
    {
        ...
        ((((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)))->I2CON = (1ul << 7) | (1ul << 6) | (0x28UL));
        _I2C_WAIT_READY_TIMEOUT(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)));
         
        ((((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)))->I2CDAT = (0x3A));((((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)))->I2CON = (1ul << 6) | (1ul << 3)); 
        _I2C_WAIT_READY_TIMEOUT(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)));
        if(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CSTATUS == 0x18){ 
             
            ((((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)))->I2CDAT = (u32Addr & 0xFFUL));((((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)))->I2CON = (1ul << 6) | (1ul << 3)); 			
            _I2C_WAIT_READY_TIMEOUT(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)));
						...
						if(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CSTATUS == 0x28){
								...
								if(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CSTATUS == 0x10 || ((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CSTATUS == 0x08){
										 
										 
										((((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)))->I2CDAT = (0x3B));((((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)))->I2CON = (1ul << 6) | (1ul << 3));
										_I2C_WAIT_READY_TIMEOUT(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)));												
										if(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CSTATUS == 0x40){
												 
												u8Data = I2C_ReadNak(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)));
												
												if(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CSTATUS == 0x58){
														 
														  
														((((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)))->I2CON = (1ul << 7) | (1ul << 6) | (0x18UL));
												}else{
	...
	do {
			...
			if(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CSTATUS == 0x18){ 
					...
					if(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CSTATUS == 0x28){
							...
							((((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)))->I2CDAT = (u8Data));((((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)))->I2CON = (1ul << 6) | (1ul << 3));
							_I2C_WAIT_READY_TIMEOUT(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000)));
							if(((I2C_T *) ((( uint32_t)0x40000000) + 0x20000))->I2CSTATUS == 0x28){
...
void UART0_Init(void)
{
    ...
    ((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->BAUD = ((1ul << 29) | (1ul << 28)) | ((((12000000UL) + (9600/2)) / 9600)-2);
...
int main(void)
{
	...
	((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x00C0)))->PMD = ((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x00C0)))->PMD & ~((0x3UL) << ((2)<<1))) | ((0x1UL) << ((2)<<1))); 
	((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x00C0))->DOUT |= (1<<2); 
	((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x00C0)))->PMD = ((((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x00C0)))->PMD & ~((0x3UL) << ((3)<<1))) | ((0x1UL) << ((3)<<1))); 
	((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x00C0))->DOUT |= (1<<3); 
